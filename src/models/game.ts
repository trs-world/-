...
export function createDefaultDemons(): Demon[] {
  return [
    ...
    {
      id: 'ketupat-kepat-prekpat-tank',
      name: 'ケトゥパト・ケパト・プレクパト',
      level: 1,
      baseAttack: 13,
      baseDefense: 18,
      baseSpeed: 5,
    ...
    {
      id: 'bururu-es-te-patipum-attacker',
      name: 'ブルル・エス・テー・パティプム',
      level: 1,
      baseAttack: 15,
      baseDefense: 8,
      baseSpeed: 12,
    ...
    {
      id: 'mangorini-palloccini-support',
      name: 'マンゴリ二・パッロチ二',
      level: 1,
      baseAttack: 12,
      baseDefense: 12,
    ...
    {
      id: 'bullu-bullu-gangster-guzzini-attacker',
      name: 'ブッル・ブッル・ガングステル・グシニ',
      level: 1,
      baseAttack: 17,
      baseDefense: 8,
      baseSpeed: 11,
    ...
    {
      id: 'bluebellini-tatticini-support',
      name: 'ブルエベッリニ・タッティチニ',
      level: 1,
      baseAttack: 11,
      baseDefense: 13,
