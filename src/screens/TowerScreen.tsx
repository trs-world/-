...
export default function TowerScreen() {
  ...
  const spriteSheetsById: Record<string, any> = React.useMemo(
    () => ({
      ...
      'ampari-babbel-support': require('../../assets/moving/アンパリ・バッベル-sheet.png'),
      'canneloni-dragoni-attacker': require('../../assets/moving/カネロニ・ドラゴーニ.png'),
      'kiwitt-bandit-attacker': require('../../assets/moving/キウィット・バンディット.png'),
      'kudanire-astronaut-support': require('../../assets/moving/クダニレ・アストロノート.png'),
      'ketupat-kepat-prekpat-tank': require('../../assets/moving/ケトゥパト・ケパト・プレクパト-sheet.png'),
      'bururu-es-te-patipum-attacker': require('../../assets/moving/ブルル・エス・テー・パティプム-sheet.png'),
      'mateo-attacker': require('../../assets/moving/マテーオ-sheet.png'),
      'mangorini-palloccini-support': require('../../assets/moving/マンゴリ二・パッロチ二-sheet.png'),
      'bullu-bullu-gangster-guzzini-attacker': require('../../assets/moving/ブッル・ブッル・ガングステル・グシニ-sheet.png'),
      'bluebellini-tatticini-support': require('../../assets/moving/ブルエベッリニ・タッティチニ-sheet.png'),
      'leonelli-cactaseri-tank': require('../../assets/moving/レオネッリ・カクタセリ-sheet.png'),
    }),
    [],
  );
